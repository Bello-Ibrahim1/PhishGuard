...
from adversarial_eval import CASES
...
def risk_to_pred(risk):
    # Treat Medium+High as "flagged as suspicious"; Low as "not flagged"
...
def main():
    ...
    for label, sender, subject, body in CASES:
        ...
        rows.append((label, pred, out["risk"], out.get("threat_pct"), sender[:35], subject[:45], correct))
